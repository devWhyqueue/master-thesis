...
flowchart TD
    ...
    S3["<b>02_patient_shortage/01_cause</b><br/>Discrimination and calibration of<br/>common learning methods<br/><i>exp. 03–04</i>"]
    S4["<b>02_patient_shortage/00_damage · 01_cause</b><br/>Patch shortage is repairable;<br/>patient shortage is not<br/><i>exp. 05–15</i>"]
    S5["<b>02_patient_shortage/01_cause</b><br/>Few patients estimate the class<br/>distribution moments badly:<br/>centre error ~3/4, directions ~1/4<br/><i>exp. 16–18</i>"]
    S6["<b>02_patient_shortage/02_mitigation</b><br/>Cohort-only moment repairs close<br/>at most ~15% of the 5→20 gap,<br/>none on BRACS; missing patient<br/>directions need more patients<br/><i>exp. 19–24</i>"]
