...
| Path | Purpose |
|---|---|
| `experiments/02_benchmark_patch/` | Unified controlled class-imbalance benchmark |
| `experiments/02_benchmark_patch/code/` | Importable benchmark package and test suite |
| `experiments/02_benchmark_patch/report/main.pdf` | Controlled-benchmark report |
...
uv run pytest experiments/02_benchmark_patch/code/tests
uv run pyright
uv run ruff check .
```
...
```bash
uv run python experiments/02_benchmark_patch/code/__main__.py --help
uv run python experiments/02_benchmark_patch/code/__main__.py submit --dry-run
```
