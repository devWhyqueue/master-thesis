"""Command-line entry point for the centre-shrinkage experiment."""
...
from shrinkage.analyze import run_analyze
from shrinkage.fit import run_fit_shard
...
def _parser() -> argparse.ArgumentParser:
    """Create the centre-shrinkage command-line argument parser."""
    parser = argparse.ArgumentParser(description="Centre Shrinkage Experiment CLI")
...
def cmd_fit(args: argparse.Namespace) -> None:
    """Fit every pending S/St arm of one (split, draw) shard."""
