...
- [`../report/2_benchmark_patch_protocol.tex`](../report/2_benchmark_patch_protocol.tex) is the protocol authority. Do not edit it unless explicitly asked.
...
```powershell
uv run pytest experiments/2_benchmark/02_benchmark_patch/code/tests
uv run python "$env:USERPROFILE\.codex\skills\clean-code\run.py" --scope experiments/2_benchmark/02_benchmark_patch/code --vulture-scope experiments/2_benchmark/02_benchmark_patch/code
```
