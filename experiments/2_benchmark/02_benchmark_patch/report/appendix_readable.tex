...
\input{assets/readable/support.tex}
...
\begin{table}[H]
\centering\small
\input{assets/readable/tuning_TCGA-UT.tex}
...
\input{assets/readable/damage.tex}
...
\begin{table}[H]
\centering\small\setlength{\tabcolsep}{4pt}
\input{assets/readable/calibration_damage.tex}
...
\input{assets/readable/recovery_BRACS.tex}
...
\begin{table}[H]
\centering\footnotesize\setlength{\tabcolsep}{3pt}\renewcommand{\arraystretch}{1.35}
\input{assets/readable/recovery_TCGA-UT.tex}
...
\begin{table}[H]
\centering\footnotesize\setlength{\tabcolsep}{3pt}
\input{assets/readable/matched_damage.tex}
...
\begin{table}[H]
\centering\footnotesize\setlength{\tabcolsep}{3pt}
\input{assets/readable/matched_calibration.tex}
...
\input{assets/readable/matched_beta.tex}
...
\begin{table}[H]
\centering\footnotesize\setlength{\tabcolsep}{3pt}\renewcommand{\arraystretch}{1.35}
\input{assets/readable/calibration_recovery_BRACS.tex}
...
\begin{table}[H]
\centering\footnotesize\setlength{\tabcolsep}{3pt}\renewcommand{\arraystretch}{1.35}
\input{assets/readable/calibration_recovery_TCGA-UT.tex}
...
\begin{table}[H]
\centering\footnotesize\setlength{\tabcolsep}{4pt}
\input{assets/readable/roster_BRACS.tex}
...
\begin{table}[H]
\centering\footnotesize\setlength{\tabcolsep}{4pt}
\input{assets/readable/roster_TCGA-UT.tex}
...
\begin{table}[H]
\centering\small
\input{assets/readable/tiers_BRACS.tex}
...
\begin{table}[H]
\centering\small
\input{assets/readable/tiers_TCGA-UT.tex}
...
\begin{table}[H]
\centering\footnotesize\setlength{\tabcolsep}{3pt}
\input{assets/readable/calibration.tex}
...
\input{assets/readable/calibration_interpretation.tex}
...
\begin{table}[H]
\centering\small\setlength{\tabcolsep}{4pt}
\input{assets/readable/split_damage.tex}
...
\begin{table}[H]
\centering\small\setlength{\tabcolsep}{4pt}
\input{assets/readable/split_calibration.tex}
...
\begin{table}[H]
\centering\footnotesize\setlength{\tabcolsep}{3pt}
\input{assets/readable/cost_BRACS.tex}
...
\begin{table}[H]
\centering\footnotesize\setlength{\tabcolsep}{3pt}
\input{assets/readable/cost_TCGA-UT.tex}
