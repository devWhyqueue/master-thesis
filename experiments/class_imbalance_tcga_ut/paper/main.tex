...
\section{Dataset and Shared Splits}
...
\begin{table}[ht]
  ...
  \begin{tabular}{p{0.22\linewidth}p{0.25\linewidth}p{0.43\linewidth}}
    ...
    Algorithm-level & CFAL & Class-balanced Gaussian-affinity loss over learned class prototypes, with center-focused modulation on patch embeddings. \citep{mahbub2024centerFocused}\\
...
The two representative advanced patch methods do not improve the controlled patch benchmark. ProGAN augmentation reaches macro F1 $0.299 \pm 0.021$, below CE and focal loss, and CFAL reaches $0.278 \pm 0.007$. The result should not be interpreted as a general rejection of synthetic generation or prototype-affinity objectives. It is narrower: under this fixed patch set, classifier family, and three-seed configuration, the extra mechanisms did not outperform simpler objective and sampler baselines.
