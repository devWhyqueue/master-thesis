...
from scripts.mil.metrics import _tier_metrics
from scripts.training.support import dataset_tier_support
...
def main() -> None:
    ...
    for benchmark in benchmarks:
        ...
        print(f"{benchmark}: updated {updated}/{scanned} result files")
