"""Command-line entry point for the spectrum-regularization experiment."""
...
from spectrum.analyze import run_analyze
from spectrum.fit import run_fit_shard
...
def _parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Spectrum Regularization Experiment CLI"
    )
...
def cmd_fit(args: argparse.Namespace) -> None:
    """Fit every pending spectrum arm of one (split, draw) shard."""
