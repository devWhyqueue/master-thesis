"""Command-line entry point for the directional-shrinkage experiment."""
...
from directional.analyze import run_analyze
from directional.fit import run_fit_shard
...
def _parser() -> argparse.ArgumentParser:
    """Create the directional-shrinkage command-line argument parser."""
    parser = argparse.ArgumentParser(description="Directional Shrinkage Experiment CLI")
...
def cmd_fit(args: argparse.Namespace) -> None:
    """Fit every pending A/At arm of one (split, draw) shard."""
    run_fit_shard(load_config(args.config), args.shard_index)


def cmd_analyze(args: argparse.Namespace) -> None:
    """Pool reused and new arm accuracy and write gains, recovery, and shares."""
