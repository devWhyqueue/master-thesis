"""Pytest fixtures and environment configuration for the shortage-decomposition tests."""
...
_EXP13_CODE = next(chain(_EXPERIMENTS.glob("*/13_coverage_similarity/code"), _EXPERIMENTS.glob("*/*/13_coverage_similarity/code")))
