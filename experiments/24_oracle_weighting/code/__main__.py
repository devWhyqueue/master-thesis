"""Command-line entry point for the oracle weighting experiment."""
...
from weighting.analyze import run_analyze
from weighting.fit import run_fit_shard
...
def _parser() -> argparse.ArgumentParser:
    """Create the oracle weighting command-line argument parser."""
    parser = argparse.ArgumentParser(description="Oracle Weighting Experiment CLI")
...
def cmd_fit(args: argparse.Namespace) -> None:
    """Fit every pending oracle-weighting arm of one (split, draw) shard."""
    run_fit_shard(load_config(args.config), args.shard_index)


def cmd_analyze(args: argparse.Namespace) -> None:
    """Pool reused and new arm accuracy and write gains, contrasts, and diagnostics."""
