...
_CODE_DIRS = (
    ...
    "16_centre_error",  # centre.arms.move_centres, centre.cohort.patient_rows
    ...
    "34_separation_intervention",  # separation.* : frozen alpha, native centres, TCGA-UT G=10 draw
)
