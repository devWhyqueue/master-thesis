"""Command-line entry point for the site-coverage experiment."""
...
from sites import FIT_SHARD_COUNT
from sites import analyze as analyze_stage
from sites import stages as stages_stage


def _parser() -> argparse.ArgumentParser:
    """Create the site-coverage command-line argument parser."""
    parser = argparse.ArgumentParser(description="Site Coverage Experiment CLI")
...
def cmd_census(args: argparse.Namespace) -> None:
    """Census the site-class pool and gate the fit array on it."""
    stages_stage.run_census(load_config(args.config))


def cmd_fit(args: argparse.Namespace) -> None:
    """Run one (split, allocation) shard of the site-coverage fits."""
