"""Command-line entry point for the shortage-selection experiment."""
...
from shortage import ALLOCATIONS, FIT_SHARD_COUNT
from shortage.allocation import allocation_frames
from shortage.analyze import run_analyze
from shortage.census import run_census


def _parser() -> argparse.ArgumentParser:
    """Create the shortage-selection command-line argument parser."""
    parser = argparse.ArgumentParser(description="Shortage Selection Experiment CLI")
...
def cmd_census(args: argparse.Namespace) -> None:
    """Census the random/dispersed five-patient arms and gate the fit array on rho_sel."""
    run_census(load_config(args.config))


def cmd_fit(args: argparse.Namespace) -> None:
    """Run one (split, allocation) shard of the shortage-selection fits."""
...
def cmd_analyze(args: argparse.Namespace) -> None:
    """Compute the selection gain and its interpretation."""
