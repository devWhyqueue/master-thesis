...
\label{app:endpoints}
This appendix defines secondary endpoints, score semantics, resampling, diagnostics, and confirmatory testing. Gates and recovery retain the main-text definitions in Section~\ref{sec:recovery}.
...
\begin{description}
  ...
  \item[Case-macro estimate.] An equal-weight aggregation over slides or partitioning units, limiting domination by heavily tiled cases.
