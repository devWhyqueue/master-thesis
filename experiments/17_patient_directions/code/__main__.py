"""Command-line entry point for the patient-directions experiment."""
...
from directions.analyze import run_analyze
from directions.fit import run_fit_shard
...
def _parser() -> argparse.ArgumentParser:
    """Create the patient-directions command-line argument parser."""
    parser = argparse.ArgumentParser(description="Patient Directions Experiment CLI")
...
def cmd_fit(args: argparse.Namespace) -> None:
    """Fit every pending RW/RWc arm of one (split, draw) shard."""
    run_fit_shard(load_config(args.config), args.shard_index)


def cmd_analyze(args: argparse.Namespace) -> None:
    """Pool reused and new arm accuracy and write gaps, shares, and interaction."""
