"""Command-line entry point for the cohort-composition experiment."""
...
from composition import ALLOCATIONS, FIT_SHARD_COUNT
from composition.allocation import allocation_frames
from composition.analyze import run_analyze
from composition.census import run_census


def _parser() -> argparse.ArgumentParser:
    """Create the cohort-composition command-line argument parser."""
    parser = argparse.ArgumentParser(description="Cohort Composition Experiment CLI")
...
def cmd_census(args: argparse.Namespace) -> None:
    """Census the clustered/random/dispersed pool and gate the fit array on it."""
    run_census(load_config(args.config))


def cmd_fit(args: argparse.Namespace) -> None:
    """Run one (split, allocation) shard of the cohort-composition fits."""
