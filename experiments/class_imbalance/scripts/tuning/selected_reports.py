...
from scripts.tuning.grid import SEEDS
...
def _report_commands(python: str) -> list[list[str]]:
    return [
        [python, "-m", "scripts.report.recompute_tier_metrics"],
        [python, "-m", "scripts.report.aggregate", "--benchmark", "patch"],
        [python, "-m", "scripts.report.aggregate", "--benchmark", "wsi_bag"],
        [python, "-m", "scripts.report.calibration_table"],
        [python, "-m", "scripts.report.calibration_posthoc_table"],
        [
            python,
            "-m",
            "scripts.report.posthoc_calibration",
            "--seed",
            "0",
            "--calibrators",
            "temperature",
        ...
        [python, "-m", "scripts.report.audit_calibration"],
    ]
