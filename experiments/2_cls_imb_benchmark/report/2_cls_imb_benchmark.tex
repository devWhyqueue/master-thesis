...
\begin{table}[ht]
  ...
  \begin{tabularx}{\linewidth}{@{}l>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X@{}}
    ...
    \bottomrule
  \end{tabularx}
  \caption{Dataset-specific definitions of patch-level examples and bag-level examples. Only TCGA-UT uses the same target in both regimes. CAMELYON16 and PANDA have different patch and bag targets, while BRACS has no unambiguous bag-level target.}
  \label{tab:datasets}
\end{table}
