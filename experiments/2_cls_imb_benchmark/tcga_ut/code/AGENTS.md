# Agent Navigation & Script Guide: `experiments/2_cls_imb_benchmark/tcga_ut/code`
...
* **Linter:** `uv run ruff check experiments/2_cls_imb_benchmark/tcga_ut/code`
* **Dead Code:** `uv run vulture experiments/2_cls_imb_benchmark/tcga_ut/code`
* **Type Safety:** `uv run pyright`
* **Tests:** `uv run pytest experiments/2_cls_imb_benchmark/tcga_ut/tests`
