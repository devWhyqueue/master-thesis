...
```bash
uv run ruff check experiments/2_cls_imb_benchmark/tcga_ut/code    # Linter check
uv run vulture experiments/2_cls_imb_benchmark/tcga_ut/code       # Dead code check
uv run pyright                                           # Type safety check
uv run pytest experiments/2_cls_imb_benchmark/tcga_ut/tests          # Run tests
```
