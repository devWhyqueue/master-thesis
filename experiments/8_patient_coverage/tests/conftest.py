"""Pytest fixtures and environment configuration for the patient-coverage tests."""
...
_EXP7_CODE = _CODE.parents[1] / "7_site_coverage" / "code"

for _code_dir in (_CODE, _EXP2_CODE, _EXP3_CODE, _EXP4_CODE, _EXP5_CODE, _EXP6_CODE, _EXP7_CODE):
