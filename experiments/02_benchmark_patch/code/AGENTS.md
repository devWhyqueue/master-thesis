...
uv run python "$env:USERPROFILE\.codex\skills\clean-code\run.py" --scope experiments/02_benchmark_patch/code --vulture-scope experiments/02_benchmark_patch/code
```
