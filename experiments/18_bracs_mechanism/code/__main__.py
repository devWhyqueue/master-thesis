"""Command-line entry point for the BRACS mechanism experiment."""
...
from mechanism.analyze import run_analyze
from mechanism.fit import run_fit_shard
...
def _parser() -> argparse.ArgumentParser:
    """Create the BRACS mechanism command-line argument parser."""
    parser = argparse.ArgumentParser(description="BRACS Mechanism Experiment CLI")
